...
public class WebAPI {
    ...
    public void setUp(@Optional("false") boolean useCloudEnv, @Optional("false") String cloudEnvName,
                      @Optional("OS X") String os, @Optional("10.14.5") String os_version, @Optional("chrome-options") String browserName, @Optional("80")
    ...
    public WebDriver getLocalDriver(   @Optional("mac")    String OS, String browserName) {
        if (browserName.equalsIgnoreCase("chrome")) {
            if (OS.equalsIgnoreCase("OS X")) {
                System.setProperty("webdriver.chrome.driver", "/Users/faisalkarim/IdeaProjects/BootCampSelenium/Generic/BrowserDriver/Mac/chromedriver 3");
